...
1. **Текст**:
   ...
   - Изображение – название переменной, которая содержит изображение для вставки.
...
Компонент, производящий запись данных в документ Word. Включает в себя следующие свойства:
...
Заменяет все вхождения исходного текста на новый. Включает в себя следующие свойства:
...
Ищет вхождение заданного текста в документ. Включает в себя следующие свойства:
...
1. **Текст**:
   ...
   - Переменная — обязательно для заполнения. Переменная для хранения результатов чтения.
...
П ереименовывает страницу в ODF-документе. Путь до файла указывается в контейнере **Таблица ODF**. Включает в себя следующие свойства (обязательны для заполнения):
