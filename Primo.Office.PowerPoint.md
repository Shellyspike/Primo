...
Все перечисленные ниже элементы добавляются в рабочую область внутри элемента **Приложение PowerPoint**. Это элемент, производящий подключение к приложению PowerPoint. В случае отсутствия указанного файла, будет создан новый. Элемент **Приложение PowerPoint** включает в себя следующие свойства:
